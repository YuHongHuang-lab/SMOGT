...
# MM
EBuider = EvaluationBuider(config=config,
                           embedding_path='/mnt/data/home/tycloud/workspace/algorithms_raw_paper_4/data/avg_df_42_MM.csv',
                           negative_ratio=1)
EBuider.load_embedding()
result = EBuider.analysis(edge_types=['TF-CRE', 'CRE-CRE'])
...
buider = NetworkBuider(config=config,
                       ...
                       method='dot',
                       topp_CRE=0.01)
buider.load_data(file_path='/mnt/data/home/tycloud/workspace/algorithms_raw_paper_4/data/avg_df_42_MM.csv')
buider.buide_networks()
buider.save_networks(base_dir='/mnt/data/home/tycloud/workspace/algorithms_raw_paper_4/data/Melanoma/processed/hummus_MM')
